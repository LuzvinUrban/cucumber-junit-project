...
public class WebTableLogin_StepDefs {
    ...
    WebTableLoginPage webTableLoginPage = new WebTableLoginPage(); // ends with ; and not {
   ...
   //     webTaleLoginPage.inputUsername.sendKeys(username);
    //    webTaleLoginPage.inputPassword.sendKeys(password);
    //    webTaleLoginPage.loginButton.click();
