...
//Methods are static. Because we do not want to create an object to call those methods.
    ...
    public static List<String> dropdownOptionsAsString(WebElement dropdownElement) {
        ...
        //for with using for loop we will convert each WebElement of options to String with using getText() method
        //with using add() method we will add each String option in List<of String>actual options as String
